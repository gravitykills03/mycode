...
def showInstructions():
    ...
    Commands:
      ...
      get [item]
    ''')
#change show Status to be more unique
def showStatus():
...
while True:
    ...
    if move[0] == 'get' :
        ...
        # start monster fight
        # add attacks and turns for player
        # get item after defeating a monster
        ## If a player enters a room with a monster
    if 'item' in rooms[currentRoom] and 'monster' in rooms[currentRoom]['item']:
        print('A monster has got you... GAME OVER!')
        break
# create locked doors that only open with a key
# develop a map to print out
